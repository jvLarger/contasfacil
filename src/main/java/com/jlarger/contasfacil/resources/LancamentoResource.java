...
import com.jlarger.contasfacil.services.LancamentoService;
...
public class LancamentoResource {
	...
	@GetMapping
	public ResponseEntity<List<LancamentoDTO>> findAll(Pageable pageable) {
		List<LancamentoDTO> list = service.findAll(pageable);		
